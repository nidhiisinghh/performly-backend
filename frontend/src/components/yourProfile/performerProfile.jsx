...
const PerformerProfile = () => {
  ...
  useEffect(() => {
    const fetchPerformerDetails = async () => {
      try {
        ...
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/performers/me`, {
          headers: {
  ...
  return (
    <div className="pl-24 min-h-screen w-full bg-black text-white relative overflow-hidden flex items-center justify-center p-6">
